# BEGIN OPENCLAW SOFTWARE FACTORY
This repository uses the `mention-scout` OpenClaw software factory.

Read `.factory/project.yaml`, product, architecture, standards, release policy,
and the active task/specification before changing code.
